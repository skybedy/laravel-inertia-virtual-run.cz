           ...
           <h3 class="bg-gray-100 -mt-4 -mx-6 p-3 text-base text-center font-bold border-b border-gray-200 border-solid text-gray-500">MÁTE-LI UŽ ÚČET, PŘIHLASTE SE</h3>
            ...
            <form @submit.prevent="submit" class="mt-4">
                <div>
                    ...
                    <BigDangerButton class="mt-3 bg-green-500  hover:bg-green-800">Přihlásit</BigDangerButton>
                </div>
            </form>
        </template>
        <template #div2>
            ...
            <Link :href="route('register')" class="mt-5 md:mt-32 md:py-20 w-full inline-block items-center px-1 py-3 mb-1 border border-transparent rounded-md font-semibold text-xl text-white uppercase tracking-widest hover:bg-blue-800 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150 text-center bg-red-500">Registrovat</Link>
        </template>
    </GuestLayout>
</template>
